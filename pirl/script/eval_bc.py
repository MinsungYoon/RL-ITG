...
from imitation_learning import core

rospy.init_node("eval_main")

cur_dir_path = os.path.dirname(os.path.abspath(__file__))
log_path = 'imitation_learning/log/N__SGMLP_ep_10000_lr_0.0003_bs_8192_step_500_wd_7e-06_gclip_0.0_hids_[1024, 512, 256]_BN_False_DR_False_Actll_vel'
...
def get_action(o): # default: stocastic action
    return pi(torch.as_tensor(o, dtype=torch.float32), deterministic=True, with_logprob=False)
